...
5.  **[发送丰富消息]** (格式: \`角色ID:内容\`)
    ...
    *   \`角色ID:[图片:{"type":"desc","value":"对图片的详细描述"${n?',"ai_prompt":"用于绘图AI的英文Tag"':""}}]\`
    *   \`角色ID:[位置:具体的地点名称]\`
    *   \`角色ID:[文件:文件名.后缀]\`
