...
<div class="studio-control-row">
	...
	<div class="control-wrapper">
		<input type="range" id="bubble-wiggle-slider" min="0" max="10" step="0.5" value="0" style="width: 6rem;">
